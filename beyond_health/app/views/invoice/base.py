...
from beyond_health.app.serializers.invoice import InvoiceListSerializer, InvoiceDetailsSerializer
from beyond_health.app.views.base import BaseViewSet
from beyond_health.db.models import Invoice
# from beyond_health.app.services.invoice_pdf_service import InvoicePdfService
...
class InvoiceViewSet(BaseViewSet):
    ...
    @allow_permission([ROLE.ADMIN, ROLE.STAFF])
